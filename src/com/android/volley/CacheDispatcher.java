				...
				try {
					response = request
							.parseNetworkResponse(new NetworkResponse(
									new FileInputStream(entry.dataFilePath),
									entry.responseHeaders));
				} catch (FileNotFoundException e) {
					// Cache file not found. This shouldn't happen, but in case
					// it does, remove the cache entry and add the request into
					// the network queue
					request.addMarker("cache-entry-not-found");
